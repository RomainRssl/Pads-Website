              ...
              <div key={p.id} className="card border-l-2 border-l-brand-orange p-5 hover:border-brand-orange/50 transition-colors">
                <div className="flex items-center gap-3 mb-4">
                  ...
                  <div className="w-9 h-9 rounded-full bg-brand-surface border border-brand-border flex items-center justify-center flex-shrink-0">
                    <span className="font-heading font-bold text-sm text-brand-orange">{p.username[0].toUpperCase()}</span>
                  </div>
                ...
                <div className="grid grid-cols-2 gap-2 pt-3 border-t border-brand-border">
                  <div className="text-center"><p className="font-heading font-bold text-base text-brand-orange leading-none">{p.xp}</p><p className="font-heading text-[9px] uppercase tracking-wider text-brand-muted mt-0.5">XP</p></div>
                  <div className="text-center"><p className="font-heading font-bold text-base text-brand-text leading-none">{p.totalRaces}</p><p className="font-heading text-[9px] uppercase tracking-wider text-brand-muted mt-0.5">Courses</p></div>
                </div>
              </div>
            ))}
          </div>
